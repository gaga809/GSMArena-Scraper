...
import { Device, DeviceMemoryInternalStorageOption } from "./types.js";
...
export async function getDevice(deviceId: string) {
  try {
    ...
    returnedDevice.network.speed = extrapolateText($, 'td[data-spec="speed"]');
    ...
    const size = extrapolateTextNoHTML($, 'td[data-spec="displaysize"]') || "";
    ...
    /// protection
    const protection = extrapolateText($, 'td[data-spec="displayprotection"]');
    ...
    console.log("Parsed device data: ", returnedDevice);
  } catch (error) {
